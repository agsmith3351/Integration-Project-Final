...
for ground_ball_input in range(3):
    ground_balls_per_minute = int(input("Enter how many ground ball pick ups in one minute: "))
...
number_of_practices_per_week = int(input("How many times per week does your team practice? "))
minutes_of_each_practice = int(input("How many minutes is each practice? "))
amount_of_time_to_drive_to_practice = int(input("How many minutes is the drive to your practice fields? "))
